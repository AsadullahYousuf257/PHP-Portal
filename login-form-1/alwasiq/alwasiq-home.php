...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    <title>Al Wasiq</title>
</head>
   
    <a href="/"><img src="./assets/img/brands-logos/logos-01-Copy.png" width="200px" style="margin-left:auto;margin-right:auto;display:block;"></a>
</head>
...
<body style="background-image:url(http://localhost/login%20form/assets/img/BG.png);">
  ...
  <nav class="main-menu" style="background: linear-gradient(180deg, #0070DF 0%, #2C2B77 100%);">
            <ul>
                <li>
                    <a href="/">
