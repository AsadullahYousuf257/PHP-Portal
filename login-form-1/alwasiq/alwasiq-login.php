...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $password = $_POST["password"];
        ...
        if($num == 1){
            ...
            header("location: alwasiq-home.php");
        }
...
<a href="/"><img src="assets/img/brands-logos/AW.png" alt="" class="main-logo-img" width="340px" style="text-align:center "></a>
  </div>
...
<h1>Login</h1>
  ...
  <button type="submit" class="btn btn-primary log-in" style="width:207px;background: linear-gradient(111.51deg, #0070DF 21.54%, #2C2B77 90.56%);;
