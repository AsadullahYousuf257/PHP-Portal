...
<a href="/"><img src="assets/img/brands-logos/Logos-05.png" alt="" class="main-logo-img" width="200px !Important" style="text-align:center "></a>
  </div>
...
<h1>Login</h1>
  ...
  <button type="submit" class="btn btn-primary log-in" style="width:207px;background: linear-gradient(111.51deg, #F27728 21.54%, #DA5100 90.56%);
